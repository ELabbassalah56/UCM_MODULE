 ...
 * Trims all characters occuring in chars_to_trim from the left and right end of text. text is modified.
 *
 * More formally: At either end of text the longest substring consisting only of characters listed in chars_to_trim is removed.
 *
 ...
 *
 * For each input string given, adds prefixes of 0..max_space_count spaces and postfixes of 0..max_space_count spaces to the string.
 * Produces all combinations of prefixes and postfixes. Returns a vector of the newly constructed strings, i.e., not containing the given input.
 *
 * Note: If input contains a value that is the result of adding spaces to another value in the input, that value will not be stripped from the output.
 *
 ...
 * \returns A vector of all input strings extended with 0..max_space_count spaces at either end, not containing the original values listed in input.
 */
