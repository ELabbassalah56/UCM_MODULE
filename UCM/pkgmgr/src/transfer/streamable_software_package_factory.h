...
///
class StreamableSoftwarePackageFactory
{
public:
    ...
    ///
    /// @return StreamableSoftwarePackage Implemenatation
    virtual std::unique_ptr<StreamableSoftwarePackage> Create(TransferIdType id) = 0;
};
