...
public:
    ...
    ///
    /// @param extractionDirectory Full file path to the extraction directory
    ///
    /// @returns The parsed SoftwarePackage
    /// @throws InvalidManifestException If there are errors parsing the manifest files.
    ///
    /// @uptrace{SWS_UCM_00029}
    virtual std::unique_ptr<SoftwarePackage> Parse(const ara::core::String& extractionDirectory) = 0;
};
