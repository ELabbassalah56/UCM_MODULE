...
PackageManagerRolledBackState::PackageManagerRolledBackState()
{
    SaveCurrentState(this->GetStatus());
    log_.LogInfo() << "Package Manager RolledBack State";
}

Future<void> PackageManagerRolledBackState::Finish(PackageManager& pm, StateAccessor& accessor)
{
