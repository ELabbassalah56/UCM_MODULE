...
#ifndef ARA_UCM_PKGMGR_PACKAGE_MANAGER_STATE_PACKAGE_MANAGER_VERIFYING_STATE_H_
#define ARA_UCM_PKGMGR_PACKAGE_MANAGER_STATE_PACKAGE_MANAGER_VERIFYING_STATE_H_
...
class PackageManagerVerifyingState final : public PackageManagerState
{
public:
    /// @brief Creates a new instance of Verifying state and saves the current state
    PackageManagerVerifyingState();
    ~PackageManagerVerifyingState() = default;
    /// <inheritdoc>
    ...
    {
        return PackageManagerStatusType::kVerifying;
    }
};
...
#endif  // ARA_UCM_PKGMGR_PACKAGE_MANAGER_STATE_PACKAGE_MANAGER_VERIFYING_STATE_H_
